...
class WalletServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            base_path('Modules/Wallet/Config/config.php') => config_path($this->moduleNameLower.'.php'),
        ], 'config');
        $this->mergeConfigFrom(
            base_path('Modules/Wallet/Config/config.php'), $this->moduleNameLower
        );
    }
    ...
    public function registerViews()
    {
        ...
        $sourcePath = base_path('Modules/Wallet/Resources/views');
