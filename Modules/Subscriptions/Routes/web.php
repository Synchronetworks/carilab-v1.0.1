...
* --------------------------------------------------------------------
*/
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth','admin','permission:view_subscriptions']], function () {
    /*
...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth','admin','permission:view_plans']], function () {
...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth','admin','permission:view_planlimitation']], function () {
