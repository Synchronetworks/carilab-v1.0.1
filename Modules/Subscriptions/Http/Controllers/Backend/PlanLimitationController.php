...
class PlanLimitationController extends Controller
{
    ...
    public function __construct()
    {
        $this->traitInitializeModuleTrait(
            __('messages.plan_limits'), // module title
    ...
    public function store(PlanLimitationRequest $request)
    {
        ...
        $this->logActivity('create',$data,'planlimitation_create');
    ...
    {
        $module_title = __('messages.plan_limits');
    ...
    public function edit($id)
    {
        ...
        $module_title =  __('messages.plan_limits');
        return view('subscriptions::backend.planlimitation.edit_form',compact('module_action','data','module_title'));
    ...
    public function update(PlanLimitationRequest $request, $id)
    {
        ...
        $this->logActivity('update',$data,'planlimitation_update');
    ...
    public function destroy($id)
    {
        $data = PlanLimitation::findOrFail($id);
        $data->delete();
        $this->logActivity('delete',$data,'planlimitation_delete');
    ...
    public function restore($id)
    {
        ...
        $data->restore();
        $this->logActivity('restore',$data,'planlimitation_restore');
    ...
    public function forceDelete($id)
    {
        $data = PlanLimitation::withTrashed()->where('id',$id)->first();
        $data->forceDelete();
        $this->logActivity('force_delete',$data,'planlimitation_force_delete');
