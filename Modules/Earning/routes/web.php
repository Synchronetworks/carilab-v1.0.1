...
* --------------------------------------------------------------------
*/
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth', 'permission:view_vendor_earnings|view_collector_earnings']], function () {
    /*
    ...
    */
    ...
    Route::group(['prefix' => 'earnings', 'as' => 'earnings.'],function () {
      ...
      Route::get("vendor_index_data", [EarningsController::class, 'vendor_index_data'])->name("vendor_index_data");
     
    });
    Route::resource("earnings", EarningsController::class);
    Route::get('vendor-earning', [EarningsController::class, 'vendorEarning'])->name('earnings.vendorEarning');
});
