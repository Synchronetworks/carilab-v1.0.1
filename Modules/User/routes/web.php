...
use Modules\User\Http\Controllers\Backend\CustomerController;
 ...
 * --------------------------------------------------------------------
 */
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth', 'admin','permission:view_user|view_customer']], function () {
  /*
  ...
  Route::group(['prefix' => 'users', 'as' => 'users.'], function () {
    ...
    Route::delete('/force_delete/{id}', [UsersController::class, 'forceDelete'])->name('force_delete');

    Route::post('check-unique', [UsersController::class, 'checkUnique'])->name('check_unique');


  });
  Route::group(['prefix' => 'customer', 'as' => 'customer.'], function () {
    Route::get("index_data", [CustomerController::class, 'index_data'])->name("index_data");
    Route::get("other_members", [CustomerController::class, 'other_members'])->name("other_members");
    Route::post('check-unique', [CustomerController::class, 'checkUnique'])->name('check_unique');
  });
