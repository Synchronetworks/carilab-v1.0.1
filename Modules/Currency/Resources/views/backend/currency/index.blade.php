        ...
        <x-backend.section-header>
            ...
            <x-slot name="toolbar">
                ...
                <div class="input-group flex-nowrap">
                    ...
                    <input type="text" class="form-control dt-search" placeholder="{{__('messages.lbl_search')}}" aria-label="Search"
                        aria-describedby="addon-wrapping">
                </div>

                <!-- Add New Post Button -->
                @hasPermission('add_currency')
                <a href="{{ route('backend.' . $module_name . '.create') }}" class="btn btn-primary d-flex justify-content-center align-items-center gap-1" id="add-post-button">
                    <i class="ph ph-plus-circle align-middle"></i>{{__('messages.new')}}
                </a>
                @endhasPermission
