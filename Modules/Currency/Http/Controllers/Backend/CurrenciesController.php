...
class CurrenciesController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->traitInitializeModuleTrait(
            'messages.lbl_currencies', // module title
    ...
    public function bulk_action(Request $request)
    {
        ...
        $moduleName = __('messages.lbl_currencies'); // Adjust as necessary for dynamic use
    ...
    public function store(CurrencyRequest $request)
    {
        ...
        $this->logActivity('create',$data,'currency_create');
     ...
     */ public function update(CurrencyRequest $request, $id)
    {
        ...
        $this->logActivity('update',$data,'currency_update');
     ...
     */
     ...
     public function destroy($id)
     {
         ...
         $data->delete();
         $this->logActivity('delete',$data,'currency_delete');
         $message = __('messages.currency_deleted');

         if (request()->wantsJson()) {
             return response()->json(['message' => $message, 'status' => true], 200);
         } else {
             flash('<i class="fas fa-check"></i> '.label_case($this->module_name).' '.__('messages.delete_form'))->success()->important();
    ...
    public function restore($id)
    {
        ...
        $data->restore();
        $this->logActivity('restore',$data,'currency_restore');
    ...
    public function forceDelete($id)
    {
        $data = Currency::withTrashed()->findOrFail($id);
        $data->forceDelete();
        $this->logActivity('force_delete',$data,'currency_force_delete');
