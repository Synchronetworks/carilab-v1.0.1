...
class ConstantsController extends Controller
{
    ...
    public function __construct()
    {
        $this->traitInitializeModuleTrait(
            'messages.lbl_constants', // module title
    ...
    public function index(Request $request)
    {
        ...
        return view('constant::backend.index', compact('module_action', 'filter', 'export_import', 'export_columns', 'export_url'));
    }
    ...
    public function bulk_action(Request $request)
    {
        ...
        $moduleName = __('messages.lbl_constants');
    ...
    public function index_data(Datatables $datatable, Request $request)
{
    ...
    return $datatable->eloquent($query)
        ...
        ->addColumn('action', function ($data) {
            return view('constant::backend.action', compact('data'));
        })
...
{
    $module_title = __('messages.lbl_constant_create');

    $types = Constant::distinct()->pluck('type'); 
    return view('constant::backend.create', compact('module_title', 'types'));
}
    ...
    public function store(ConstantRequest $request)
    {
        ...
        if ($existingConstant) {
            ...
            $this->logActivity('update',$existingConstant,'constant_update');
            $message = trans('messages.update_form');;
        } else {
            $constant = Constant::create($data);
            $this->logActivity('create',$constant,'constant_create');
    ...
    {
        $module_title = __('messages.lbl_constant_edit');
        $data = Constant::find($id);
        $types = Constant::distinct()->pluck('type'); 
       
        return view('constant::backend.edit', compact('module_title','data','types' ));
    ...
    public function update(Request $request, $id)
    {
        $data = Constant::find($id);
        if (!$data) {
            return redirect()->route('backend.constants.index')->with('error', __('messages.constant_not_found'));
        }
        ...
        $this->logActivity('update',$data,'constant_update');
        $message = trans('messages.update_form');
    ...
    public function destroy($id)
    {
        ...
        $data->delete();
        $this->logActivity('delete',$data,'constant_delete');
    ...
    public function restore($id)
    {
        ...
        $data->restore();
        $this->logActivity('restore',$data,'constant_restore');
    ...
    public function forceDelete($id)
    {
        $data = Constant::withTrashed()->Where('id',$id)->first();
        $data->forceDelete();
        $this->logActivity('force_delete',$data,'constant_force_delete');
