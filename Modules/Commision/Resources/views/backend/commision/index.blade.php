...
@section('title', __($moduleName))


@section('title') {{ __($moduleName) }} @endsection
            ...
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    ...
                    <div class="input-group flex-nowrap">
                     ...
                     <a href="{{ route('backend.' . $user_type . '_commisions.create') }}" class="btn btn-primary d-flex align-items-center gap-1" id="add-post-button"><i class="ph ph-plus-circle align-middle"></i>{{ __('messages.new') }}</a>
                  @endhasPermission
                                   </x-slot>
            </x-backend.section-header>
        ...
        const columns = [
            {
                name: 'check',
                data: 'check',
                title: '<input type="checkbox" class="form-check-input" name="select_all_table" id="select-all-table" data-type="commision" onclick="selectAllTable(this)">',
                width: '0%',
                exportable: false,
                orderable: false,
                searchable: false,
