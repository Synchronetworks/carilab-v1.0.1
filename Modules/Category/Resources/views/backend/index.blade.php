                        ...
                        <div class="">
                            <select name="action_type" class="form-select select2 col-12" id="quick-action-type"
                                ...
                                @can('delete_category')
                                    ...
                                    @endcan
                                    @can('restore_category')
                                    <option value="restore">{{ __('messages.restore') }}</option>
                                    @endcan
                                    @can('force_delete_category')
...
@push('after-scripts')
    ...
    <script type="text/javascript" defer>
        const columns = [{
                ...
                orderable: false,
                searchable: false,
                visible: {!! auth()->user()->can('edit_category') || auth()->user()->can('delete_category') ? 'true' : 'false' !!}
