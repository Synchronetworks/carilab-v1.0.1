    ...
    public function run()
    {
        ...
        \DB::table('pages')->insert(array (
            ...
            array (
                ...
                'slug' => 'privacy-policy',
                'sequence' => NULL,
            'description' => '<p data-pm-slice="0 0 []">Iqonic Design Kivilabs Laravel (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;) is committed to protecting your privacy. At Iqonic Design, we are committed to protecting your privacy and ensuring that your personal information is handled securely.</p>
<p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our &ldquo;Service&rdquo;) alongside our application, Iqonic Design Kivilabs Laravel. By accessing or using our Service, you signify that you have read, understood, and agree to our collection described in this Privacy Policy and our Terms of Service.</p>
<p>This Privacy Policy outlines how we collect, use, and safeguard your data when you use Kivilabs Laravel.</p>
<p><strong>1. Introduction </strong></p>
<p>At Iqonic Design, we are dedicated to safeguarding your privacy and ensuring your personal data is handled securely. This Privacy Policy explains how we collect, use, and protect your information when you use our services through the Kivilabs Laravel platform, including our website and associated applications. By accessing or using our services, you acknowledge that you have read and understood this Privacy Policy and agree to its terms.</p>
<p><strong>2. Information We Collect </strong></p>
<p>We may collect several types of information when you use Kivilabs Laravel, including:</p>
...
<p><strong>- Kivilabs LaravelAccess and CorrectionKivilabs Laravel:</strong> You may access, correct, or update your personal data through your account settings.</p>
<p><strong>- Kivilabs LaravelDeletionKivilabs Laravel:</strong> You may request the deletion of your account and associated data by contacting our support team.</p>
<p><strong>- Kivilabs LaravelData PortabilityKivilabs Laravel:</strong> You have the right to request your personal data in a structured, machine-readable format to transfer to another service provider.</p>
<p><strong>- Kivilabs LaravelOpting Out of Marketing CommunicationsKivilabs Laravel:</strong> You can opt out of receiving promotional emails or other communications at any time by adjusting your account settings or contacting us.</p>
...
<p>The Kivilabs Laravel platform is designed for use by individuals aged 13 and older. We are committed to protecting the privacy of children and do not knowingly collect personal information from individuals under the age of 13. In compliance with the Children&rsquo;s Online Privacy Protection Act (COPPA) and similar regulations, we take precautions to avoid collecting any data from minors.</p>
...
<p>&nbsp;</p>
<p><strong>This privacy policy helps ensure transparency and clarity about how Iqonic Design handles your data within Kivilabs Laravel. </strong></p>
<p><strong>Thank you for using Kivilabs Laravel. Your privacy is important to us, and we are committed to safeguarding your personal information.&nbsp;&nbsp;</strong></p>',
                'status' => 1,
                'created_by' => NULL,
                'updated_by' => 1,
                'deleted_by' => NULL,
...
<p>Upon subscribing, you are granted a limited, non-exclusive, non-transferable license to access and view the content available on Kivilabs Laravel for personal, non-commercial use. This license is intended solely for your enjoyment and personal viewing. You may not reproduce, distribute, modify, publicly display, publicly perform, republish, download, or store any content from the service without obtaining prior written consent from us. All content remains the property of Iqonic Design or its content providers, and unauthorized use of the content may result in legal action.</p>
<p><strong>7. Intellectual Property</strong></p>
<p>All content available on Kivilabs Laravel, including but not limited to movies, TV shows, graphics, logos, software, and any associated trademarks, is protected by copyright, trademark, and other intellectual property laws. You agree not to infringe, violate, or misuse any intellectual property rights belonging to Iqonic Design or third-party content providers. Unauthorized use of the content may lead to civil and criminal penalties. If you wish to use any content for commercial purposes, you must obtain prior written permission from the rightful owner.</p>
<p><strong>8. Prohibited Activities</strong></p>
<p>While using Kivilabs Laravel, you agree not to engage in any unlawful activities or conduct that violates these Terms and Conditions. This includes, but is not limited to:</p>
...
<p><strong>We appreciate your cooperation and understanding of these Terms and Conditions. They are designed to protect both your rights and those of our users, ensuring a secure and enjoyable streaming experience on Kivilabs Laravel.</strong></p>
<p>&nbsp;</p>',
                'status' => 1,
                'created_by' => NULL,
                'updated_by' => 1,
            ...
            array (
                ...
                'sequence' => NULL,
                'description' => '<p>Welcome to Kivilabs Laravel Help &amp; Support! At Iqonic Design, we strive to offer you the best streaming experience possible. Should you have any questions, concerns, or need assistance with Kivilabs Laravel, you&rsquo;ve come to the right place. Our dedicated support team is here to help you with technical issues, general queries, and everything in between. We are committed to ensuring a smooth and enjoyable streaming experience.</p>
...
<p>&nbsp; &nbsp;- Whether you\'re a new user or need help with specific features, we can guide you. Kivilabs Laravel is designed with user-friendly features, and we are here to help you make the most out of them.</p>
...
<p>- Your registered email address associated with Kivilabs Laravel.</p>
...
<p><strong>Thank you for choosing Kivilabs Laravel! Your satisfaction is our top priority, and we&rsquo;re always here to assist you with any concerns or questions.</strong></p>',
                'status' => 1,
                'created_by' => NULL,
                'updated_by' => 1,
                'deleted_by' => NULL,
            ...
            array (
                ...
                'sequence' => NULL,
                'description' => '<p>At Iqonic Design, we strive to ensure our customers have a seamless experience with Kivilabs Laravel. Please read our Refund and Cancellation Policy carefully to understand your rights and obligations.</p>
<p><strong>1. Subscription Cancellations</strong></p>
<p>You may cancel your subscription to Kivilabs Laravel at any time. Upon cancellation:</p>
...
<p>Iqonic Design reserves the right to update or modify this Refund and Cancellation Policy at any time. We will notify users of any significant changes via email or in-app notifications. Continued use of Kivilabs Laravel after changes are made will signify your acceptance of the revised policy.</p>
...
<p><strong>Thank you for choosing Kivilabs Laravel and for being a valued customer of Iqonic Design!</strong></p>
<p>Company:<strong>&nbsp;Iqonic Design&nbsp;&nbsp;</strong></p>
<p>Product:<strong>&nbsp;Kivilabs Laravel&nbsp;&nbsp;</strong></p>
<p>Support Contact:<strong>&nbsp;hello@iqonic.design</strong></p>',
            ...
            array (
                ...
                'sequence' => NULL,
                'description' => '<p>At Iqonic Design, we value the privacy of our users and are committed to ensuring your personal data is handled securely. If you wish to request the deletion of your data associated with Kivilabs Laravel, please review the following guidelines.</p>
...
<p><strong>**Please note: After the data is deleted, you will no longer have access to your Kivilabs Laravel account, and the action is irreversible**</strong></p>
...
<p>- You will lose access to your Kivilabs Laravel account.</p>
...
<p><strong>Thank you for using Kivilabs Laravel, and for trusting Iqonic Design with your privacy.</strong></p>',
                'status' => 1,
                'created_by' => NULL,
                'updated_by' => 1,
                'deleted_by' => NULL,
            ...
            array (
                ...
                'slug' => 'about-us',
                'sequence' => NULL,
                'description' => '<p><strong>About Kivilabs Laravel by Iqonic Design</strong></p>
<p>Welcome to Kivilabs Laravel, a next-generation streaming platform proudly developed by Iqonic Design. We specialize in creating cutting-edge digital solutions, and Kivilabs Laravel is our latest breakthrough in the world of online entertainment. Whether you\'re a movie lover, a TV show binge-watcher, or enjoy live events, our platform is designed to deliver high-quality content directly to your device, ensuring a seamless, uninterrupted experience. Kivilabs Laravel combines advanced technology with a user-friendly interface to cater to audiences worldwide.</p>
<p><strong>Our Mission</strong></p>
<p>Our mission at Iqonic Design is to reshape how digital content is consumed by creating a streaming platform that prioritizes speed, reliability, and personalization. Kivilabs Laravel is built using the latest technologies to provide users with superior streaming quality, customized recommendations, and an easy-to-use content management system. We are committed to making entertainment accessible and enjoyable for all audiences, whether you\'re at home or on the go.</p>
<p><strong>Why Choose Kivilabs Laravel?</strong></p>
...
<p>- Multi-Device Compatibility: Enjoy Kivilabs Laravel on your mobile, tablet, smart TV, or desktop, with seamless syncing across all devices.</p>
...
<p>- Scalable &amp; Customizable for Developers: Kivilabs Laravel offers a flexible architecture that developers can tailor to specific needs, with options for scalability and integrations with other platforms.</p>
...
<p>We envision a world where entertainment is no longer bound by geographical or technological limitations. With Kivilabs Laravel, we aim to revolutionize digital content consumption, offering users the flexibility to watch anything, anywhere, at any time. Our vision extends beyond just entertainment&mdash;we seek to empower creators by providing a dynamic platform where they can showcase their content to a global audience while maintaining full control over their media. As technology evolves, so does Kivilabs Laravel, constantly improving to meet the demands of today&rsquo;s and tomorrow&rsquo;s viewers.</p>
...
<p><strong>- Collaborative Content Creation:</strong> Kivilabs Laravel allows content creators to collaborate, share, and co-produce projects, fostering a community of innovation and creativity.</p>
...
<p><strong>- Diverse Genre Library:</strong> Explore a wide range of genres, from action and thrillers to romance, horror, and documentaries. Whatever your preference, there&rsquo;s something for everyone on Kivilabs Laravel.</p>
...
<p>Join us in our journey to transform the entertainment landscape with Kivilabs Laravel&mdash;where technology and creativity come together to offer the ultimate streaming experience.</p>
<p>Company:&nbsp;<strong>Iqonic Design&nbsp;&nbsp;</strong></p>
<p>Product:&nbsp;<strong>Kivilabs Laravel&nbsp;&nbsp;</strong></p>
<p>Support Contact:&nbsp;<strong>hello@iqonic.design</strong></p>',
                'status' => 1,
            ...
            6=>array(
                    ...
                    'slug' => 'contact-us',
                    'sequence' => null,
                     'description' => '<p><strong>Connect with Us</strong></p>
<p>We value our community and encourage feedback to help us improve. If you have any questions, suggestions, or require assistance, our support team is ready to help:</p>
<p><strong>📧 Support Email: hello@iqonic.design</strong></p>
<p>Join us in our journey to transform the business landscape with <strong>Kivilabs</strong>&mdash;where technology and creativity come together to offer the ultimate business management experience.</p>',
                'status' => 1,
                'created_by' => null,
                'updated_by' => 1,
                'deleted_by' => null,
