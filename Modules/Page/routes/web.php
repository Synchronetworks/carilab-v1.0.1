...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth','admin','permission:view_pages']], function () {
    /*
    ...
    */
    ...
    Route::group(['prefix' => 'pages', 'as' => 'pages.'],function () {
      ...
      Route::get('help-support', [PagesController::class, 'helpSupport'])->name('help-support');
