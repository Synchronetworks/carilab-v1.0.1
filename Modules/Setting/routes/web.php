...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth','admin']], function () {
    ...
    */
    ...
    Route::group(['prefix' => 'setting', 'as' => 'settings.'],function () {
      ...
      Route::get('notification-configuration', [SettingsController::class, 'notificationSetting'])->name('notification-configuration');
       Route::get('social-media-settings', [SettingsController::class, 'socialMedia'])->name('social-media'); // Define the missing route for 'misc' setting
       Route::get('/commission-setting', [SettingsController::class, 'commissionSetting'])->name('commission-setting');
       Route::post('get-lang-file', [SettingsController::class, 'getFile'])->name('getLangFile');
       Route::post('save-lang-file', [SettingsController::class, 'saveFileContent'])->name('saveLangContent');
   
       Route::get('import-data', [SettingsController::class, 'importData'])->name('import-data');
