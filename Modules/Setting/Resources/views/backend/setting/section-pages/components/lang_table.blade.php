...
{{ html()->form('POST', route('backend.settings.saveLangContent'))->attribute('data-toggle', 'validator')->id('flatArray')->open() }}
...
{{ html()->submit(__('messages.save'))->class('btn btn-md btn-primary float-md-end submit_section1 mt-4') }}
{{ html()->form()->close() }}
