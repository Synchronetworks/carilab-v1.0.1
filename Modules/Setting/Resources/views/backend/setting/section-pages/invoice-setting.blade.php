...
<div class="col-md-12 d-flex justify-content-between mb-4">
    <h4><i class="fa-solid fa-file-invoice"></i> {{ __('messages.lbl_inv_setting') }}</h4>
</div>
<form method="POST" action="{{ route('backend.setting.store') }}">
    @csrf
      <div class="row gy-3">
        <div class="form-group col-md-6">
            <label class="form-label">{{ __('messages.lbl_order_prefix') }} <span class="text-danger">*</span></label>
        ...
        <div class="form-group col-md-6">
            <label class="form-label">{{ __('messages.lbl_order_starts') }} <span class="text-danger">*</span></label>
        ...
        <div class="form-group col-12">
            <label class="form-label">{{ __('messages.lbl_spacial_note') }} <span class="text-danger">*</span></label>
