...
@section('settings-content')
    <div class="container">
        <div class="mb-4">
            <h4><i class="ph ph-coin-vertical"></i> {{ __('messages.lbl_payment') }} </h4>
        </div>
         ...
         {{-- Razorpay --}}
            <div class="form-group border-bottom pb-3 mb-3">
                <div class="d-flex justify-content-between align-items-center">
                    <label class="form-label m-0" for="payment_method_razorpay">{{ __('messages.lbl_razorpay') }}</label>
                ...
                <div class="row gy-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="razorpay_secretkey">{{ __('messages.lbl_secret_key') }}</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="razorpay_publickey">{{ __('messages.lbl_app_key') }}</label>
            ...
            <div class="mt-4">
                <div class="form-group border-bottom pb-3 mb-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <label class="form-label m-0" for="payment_method_razorpayx">{{ __('messages.lbl_razorpayx') }}</label>
                        <input type="hidden" value="0" name="razorpayx_payment_method">
                        <div class="form-check form-switch m-0">
                            <input class="form-check-input toggle-input" data-toggle-target="#razorpayx-fields" value="1"
                                name="razorpayx_payment_method" id="payment_method_razorpayx" type="checkbox"
                                {{ old('razorpayx_payment_method', $settings['razorpayx_payment_method'] ?? 0) == 1 ? 'checked' : '' }} />
                        </div>
                    </div>
                </div>
            </div>
            <div id="razorpayx-fields"
                class="ps-3 {{ old('razorpayx_payment_method', $settings['razorpayx_payment_method'] ?? 0) == 1 ? '' : 'd-none' }}">
                <div class="row gy-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="razorpayx_secretkey">{{ __('messages.lbl_secret_key') }}</label>
                            <input type="text" class="form-control @error('razorpayx_secretkey') is-invalid @enderror"
                                name="razorpayx_secretkey" id="razorpayx_secretkey"
                                value="{{ old('razorpayx_secretkey', $settings['razorpayx_secretkey'] ?? '') }}">
                            @error('razorpayx_secretkey')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="razorpayx_publickey">{{ __('messages.lbl_app_key') }}</label>
                            <input type="text" class="form-control @error('razorpayx_publickey') is-invalid @enderror"
                                name="razorpayx_publickey" id="razorpayx_publickey"
                                value="{{ old('razorpayx_publickey', $settings['razorpayx_publickey'] ?? '') }}">
                            @error('razorpayx_publickey')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="razorpayx_account_number">{{ __('messages.lbl_account_number') }}</label>
                            <input type="text" class="form-control @error('razorpayx_account_number') is-invalid @enderror"
                                name="razorpayx_account_number" id="razorpayx_account_number"
                                value="{{ old('razorpayx_account_number', $settings['razorpayx_account_number'] ?? '') }}">
                            @error('razorpayx_account_number')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    </div>
            ...
            <div class="mt-4">
                <div class="form-group border-bottom pb-3 mb-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <label class="form-label m-0" for="payment_method_stripe">{{ __('messages.lbl_stripe') }}</label>
            ...
            <div id="stripe-fields"
                ...
                <div class="row gy-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="stripe_secretkey">{{ __('messages.lbl_secret_key') }}</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="stripe_publickey">{{ __('messages.lbl_app_key') }}</label>
            ...
            <div class="mt-4">
                <div class="form-group border-bottom pb-3 mb-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <label class="form-label m-0" for="payment_method_paystack">{{ __('messages.lbl_paystack') }}</label>
            ...
            <div id="paystack-fields"
                ...
                <div class="row gy-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="paystack_secretkey">{{ __('messages.lbl_secret_key') }}</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="paystack_publickey">{{ __('messages.lbl_app_key') }}</label>
            ...
            <div class="mt-4">
                <div class="form-group border-bottom pb-3 mb-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <label class="form-label m-0" for="payment_method_paypal">{{ __('messages.lbl_paypal') }}</label>
            ...
            <div id="paypal-fields"
                ...
                <div class="row gy-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="paypal_secretkey">{{ __('messages.lbl_secret_key') }}</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="paypal_clientid">{{ __('messages.lbl_client_id') }}</label>
            ...
            <div class="mt-4">
                <div class="form-group border-bottom pb-3 mb-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <label class="form-label m-0" for="payment_method_flutterwave">{{ __('messages.lbl_flutterwave') }}</label>
            ...
            <div id="flutterwave-fields"
                ...
                <div class="row gy-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="flutterwave_secretkey">{{ __('messages.lbl_secret_key') }}</label>
                            <input type="text"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="flutterwave_publickey">{{ __('messages.lbl_app_key') }}</label>
            ...
            <div id="cinet-fields"
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="cinet_Secret_key">{{ __('messages.lbl_secret_key') }}</label>
            ...
            <div id="airtel-money-fields"
                ...
                <div class="row gy-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="airtel_money_secretkey">{{ __('messages.lbl_secret_key') }}</label>
                            <input type="text"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="airtel_money_client_id">{{ __('messages.lbl_client_id') }}</label>
                            <input type="text"
            ...
            <div id="phonepe-fields"
                ...
                <div class="row gy-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="phonepe_App_id">{{ __('messages.lbl_app_id') }}</label>
            ...
            <div id="midtrans-fields"
                ...
                <div class="row gy-4">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="midtrans_client_id">{{ __('messages.lbl_app_key') }}</label>
