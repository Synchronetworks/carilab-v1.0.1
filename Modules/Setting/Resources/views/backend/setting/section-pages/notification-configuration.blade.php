...
{{ html()->form('POST', route('backend.setting.store'))
    ...
    <div class="card">
        <div class="card-header">
            <h4><i class="ph ph-bell"></i> {{ __('messages.lbl_notification_configuration') }}</h4>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    @enderror
                    <div class="invalid-feedback" id="name-error">{{__('messages.expiry_plan_required')}}</div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                    <div class="invalid-feedback" id="name-error">{{__('messages.upcoming_required')}}</div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                    <div class="invalid-feedback" id="name-error">{{__('messages.continue_watch_required')}}</div>
                </div>
