...
<form method="POST" action="{{ route('backend.setting.store') }}" id="settings-form-data"  enctype="multipart/form-data">
    ...
    <div>
        <div class="d-flex justify-content-between align-items-center card-title">
            <h3 class="m-0"><i class="ph ph-user-list"></i> {{ __('messages.lbl_customization') }}</h3>
        </div>
    </div>
    ...
    <div>
        <div class="d-flex align-items-center justify-content-between">
            <h6 class="mt-4 mb-3">{{__('messages.color_customizer')}}</h6>
            <div class="d-flex align-items-center">
                <a href="#custom-color" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="custom-color">{{__('messages.custom')}}</a>
    ...
    <h5 class="mt-4 mb-3">{{__('messages.navbar_style')}}</h5>
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-4 g-3 mb-4">
      <div data-setting="radio" class="text-center col">
        ...
        <label class="btn btn-border  d-block text-center" for="nav-glass">{{__('messages.glass')}}</label>
      </div>
      <div data-setting="radio" class="text-center col">
        <input type="radio" value="navs-sticky" class="btn-check" name="header_navbar" id="navs-sticky" autocomplete="off">
        <label class="btn btn-border  d-block text-center" for="navs-sticky">{{__('messages.sticky')}}</label>
      </div>
      <div data-setting="radio" class="text-center col">
        <input type="radio" value="navs-transparent" class="btn-check" name="header_navbar" id="navs-transparent" autocomplete="off" checked>
        <label class="btn btn-border  d-block text-center" for="navs-transparent">{{__('messages.transparent')}}</label>
      </div>
      <div data-setting="radio" class="text-center col">
        <input type="radio" value="navs-default" class="btn-check" name="header_navbar" id="navs-default" autocomplete="off" checked>
        <label class="btn btn-border  d-block text-center" for="navs-default">{{__('messages.default')}}</label>
      </div>
    </div>
   ...
   <div data-setting="checkbox">
       <div class="d-flex justify-content-between align-items-center">
           <h6 class="mt-4 mb-3">{{__('messages.navbar_hide')}}</h6>
   ...
   <!-- navbar hide end here -->
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-3 g-3 mb-4">
            ...
            <div data-setting="radio col">
                ...
                <label class="btn btn-border d-block text-center" for="card-transparent" data-bs-toggle="tooltip"
                    ...
                    <span>{{__('messages.transparent')}}</span>
                </label>
            </div>
        </div>
    </div>
    ...
    <div class="d-none">
        <h6 class="mt-4 mb-3">{{__('messages.menu_color')}}</h6>
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-3 g-3 mb-4">
            <div data-setting="radio" class="col">
    ...
    <div>
        <h6 class="mt-4 mb-3">{{__('messages.menu_style')}}</h6>
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-4 g-3 mb-4">
            <div data-setting="checkbox" class="col text-center">
                ...
                <label class="btn btn-border d-block text-center" for="sidebar-mini">{{__('messages.mini')}}</label>
            </div>
            <div data-setting="checkbox" class="col text-center">
                ...
                <label class="btn btn-border d-block text-center" for="sidebar-hover">{{__('messages.hover')}}</label>
            </div>
            <div data-setting="checkbox" class="col text-center">
                <input type="checkbox" value="sidebar-boxed" class="btn-check"
                    name="sidebar_type" id="sidebar-boxed">
                <label class="btn btn-border d-block text-center" for="sidebar-boxed">{{__('messages.boxed')}}</label>
            </div>
            <div data-setting="checkbox" class="col text-center">
                <input type="checkbox" value="sidebar-soft" class="btn-check"
                    name="sidebar_type" id="sidebar-soft">
                <label class="btn btn-border d-block text-center" for="sidebar-soft">{{__('messages.soft')}}</label>
            </div>
        </div>
    </div>
...
<div data-setting="checkbox">
    <div class="d-flex justify-content-between align-items-center">
        <h6 class="mt-4 mb-3">{{__('messages.menu_hide')}}</h6>
        <div class="form-check form-switch">
...
<div class="mt-4 mb-3">
    <h6 class="d-inline-block mb-0 me-2">{{__('messages.footer')}} </h6>
</div>
<div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-3 g-3 mb-4">
    <div data-setting="radio">
