...
<div class="form-content">
    {{ html()->form('POST', route('backend.documents.store'))->attribute('data-toggle', 'validator')->id('documents')->open() }} 
        <div class="card">
            <div class="card-body">                    
                ...
                <div class="row gy-4">
                    <div class="form-group col-md-4">
                        ...
                        {{ html()->text('name',$documentdata->name)->placeholder(trans('messages.placeholder_name'))->class('form-control')->required()}}
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select form-control select2" name="user_type" id="user_type" required>
