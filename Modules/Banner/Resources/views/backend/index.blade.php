    ...
    <div class="table-content">
        <x-backend.section-header>
            ...
            <div class="d-flex flex-wrap gap-3">
                @if(auth()->user()->can('edit_banner') || auth()->user()->can('delete_banner'))
        ...
        const columns = [
            {
                ...
                orderable: false,
                searchable: false,
                visible: {!! auth()->user()->can('edit_banner') || auth()->user()->can('delete_banner') ? 'true' : 'false' !!}
            ...
            },
            {
                ...
                title: "{{ __('messages.lbl_description') }}"
            },
            {
                data: 'status',
                name: 'status',
