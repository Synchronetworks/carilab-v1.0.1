...
<div class="page-content">
    ...
    <div class="d-flex align-items-center gap-2 mb-4">
        <div class="custom-tab-slider">
            <ul class="nav nav-pills" id="collectorTabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="payments-collector-tab" data-bs-toggle="tab" href="#payments" role="tab">{{ __('messages.payment_history') }}</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="payouts-collector-tab" data-bs-toggle="tab" href="#payouts2" role="tab">{{ __('messages.payouts') }}</a>
                </li>
                <li class="nav-item">
    ...
    <div class="tab-content" id="collectorTabs">
        ...
        <div class="tab-pane fade show active" id="overview" role="tabpanel">
            @include('collector::backend.CollectorDetails.overview')
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-inline-flex justify-content-between align-items-center bg-primary-subtle py-3 px-3 px-lg-5 rounded mb-4 gap-3 gap-lg-5">
                        <h6 class="heading-color m-0">{{ __('messages.total_revenue') }}</h6>
        ...
        <div class="tab-pane fade" id="payouts2" role="tabpanel">
            <div class="card">
                <div class="card-body">
                    <div id="payouts-table-container"></div>
                </div>
            </div>
        </div>
...
@push('after-scripts')
   ...
   const appointmentColumns = [
           ...
           
        {
                data: 'user_id',
                name: 'user_id',
                            title: "{{ __('messages.lbl_collector') . ' ' . __('messages.lbl_name') }}"
            },
            {
                data: 'payment_method',
                name: 'payment_method',
        ...
        $('#collectorTabs a[data-bs-toggle="tab"]').on('shown.bs.tab', function (e) {
            ...
            if (e.target.id === 'appointments-tab') {
                ...
                initDatatable({
                    url: '{{ route("backend.appointments.index_data", ["collector_id" => $data->id]) }}',
                ...
                initDatatable({
                    url: '{{ route("backend.reviews.index_data", ["collector_id" => $data->id]) }}',
            ...
            } else if (e.target.id === 'payments-collector-tab') {
            ...
            } else if (e.target.id === 'payouts-collector-tab') {
                $('#payouts-table-container').html('<table id="datatable" class="table table-responsive"></table>');
                
                initDatatable({
                    url: '{{ route("backend.payouts.index_data", ["collector_id" => $data->id]) }}',
                ...
                initDatatable({
                    url: '{{ route("backend.collectordocument.index_data", ["collector_id" => $data->id]) }}',
