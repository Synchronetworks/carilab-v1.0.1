...
@section('title',__('messages.notification.template')) 
...
<script type="text/javascript" defer>
        const columns = [
            { data: 'label', name: 'label', title: "{{ __('messages.notification_templates') }}", className:"notification-lbl-white", orderable: true  },
        ]

        const actionColumn = [
            { data: 'action', name: 'action', orderable: false, searchable: false, title: "{{ __('messages.lbl_action') }}"  }
        ]
