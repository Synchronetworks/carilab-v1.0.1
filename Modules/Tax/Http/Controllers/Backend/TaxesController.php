...
class TaxesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $module_title = trans('messages.lbl_tax');
        $export_import = true;
        $export_columns = [
            [
                'value' => 'name',
        ...
        return view('tax::backend.tax.index', compact('module_action','module_title', 'filter', 'export_import', 'export_columns', 'export_url','type'));
    }
    public function index_list(Request $request)
    {
        $vendorId = $request->vendor_id ?? null;
        if($vendorId){
            $taxes = Tax::whereHas('user', function($query) use ($vendorId){
    ...
    public function store(TaxRequest $request)
    {
        $data = $request->all();
        $tax = Tax::create($data);
        $this->logActivity('create',$tax,'tax_create');
    ...
    public function update(TaxRequest $request, Tax $tax)
    {
        ...
        $this->logActivity('update',$tax,'tax_update');
    ...
    public function destroy($id)
    {
        $data = Tax::findOrFail($id);
        $data->delete();
        $this->logActivity('delete',$data,'tax_delete');
    ...
    public function restore($id)
    {
        ...
        $data->restore();
        $this->logActivity('restore',$data,'tax_restore');
    ...
    public function forceDelete($id)
    {
        $data = Tax::withTrashed()->findOrFail($id);
        $data->forceDelete();
        $this->logActivity('force_delete',$data,'tax_force_delete');
