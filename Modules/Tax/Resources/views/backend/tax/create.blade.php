...
<div class="form-content">
    ...
    {{ html()->select('type', ['' => __('messages.select_name', ['select' => __('messages.lbl_Type')]), 'Fixed' => __('messages.fixed'), 'Percentage' => __('messages.percentage')], old('type'))
            ...
            ->attribute('data-placeholder', __('messages.select_name', ['select' => __('messages.lbl_Type')])) 
                    ...
                    <div class="col-sm-6 col-md-4">
                        {{ html()->label(__('messages.value') .'<span class=" type-symbol"> (%) </span>'. ' <span class="text-danger">*</span>', 'value')->class('form-label') }}
                        {{ html()->number('value')
                         ->attribute('min', '0')
                                ->attribute('step', 'any')
