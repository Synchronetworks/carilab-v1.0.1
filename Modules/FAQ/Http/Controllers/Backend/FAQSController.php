...
class FAQSController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $module_title = trans('messages.faqs');
        $export_import = true;
        $export_columns = [
            [
                'value' => 'question',
                'text' => __('messages.lbl_question'),
            ]
        ];
        $export_url = route('backend.faqs.export');

        return view('faq::backend.faq.index', compact('module_action','module_title', 'filter', 'export_import', 'export_columns', 'export_url'));
    }
    ...
    public function bulk_action(Request $request)
    {
        ...
        $moduleName = __('messages.faqs'); // Adjust as necessary for dynamic use
    ...
    {
        $module_title = __('messages.new_faqs');
    ...
    public function store(FAQRequest $request)
    {
        $data = $request->all();
        $faq = FAQ::create($data);
        $this->logActivity('create',$faq,'FAQ_create');
    ...
    public function edit($id)
    {
        ...
        $module_title = __('messages.edit_faqs');
    ...
    public function update(FAQRequest $request, FAQ $faq)
    {
        ...
        $this->logActivity('update',$faq,'FAQ_update');
    ...
    public function destroy($id)
    {
        $data = FAQ::findOrFail($id);
        $data->delete();
        $this->logActivity('delete',$data,'FAQ_delete');
    ...
    public function restore($id)
    {
        ...
        $data->restore();
        $this->logActivity('restore',$data,'FAQ_restore');
    ...
    public function forceDelete($id)
    {
        $data = FAQ::withTrashed()->findOrFail($id);
        $data->forceDelete();
        $this->logActivity('force_delete',$data,'FAQ_force_delete');
