            ...
            <div class="row gy-3">
                ...
                <div class="col-md-6">
                    ...
                    {{ html()->text('question')
                            ...
                            ->placeholder(__('meassges.enter_question'))
                            ->class('form-control')
                            ->required() }}
                    @error('question')
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="answer" id="answer" class="form-control" placeholder="{{ __('messages.enter_answer') }}" required>{{ old('answer', $data->answer) }}</textarea>
                    @error('answer')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
