    ...
    <div class="table-content">
            ...
            <x-backend.section-header>
                <div class="d-flex flex-wrap gap-3">
                    @if(auth()->user()->can('edit_coupons') || auth()->user()->can('delete_coupons'))
...
<script type="text/javascript" src="{{ asset('vendor/datatable/datatables.min.js') }}"></script>
      ...
      const columns = [
    {
        name: 'check',
        data: 'check',
        title: '<input type="checkbox" class="form-check-input" name="select_all_table" id="select-all-table" data-type="coupons" onclick="selectAllTable(this)">',
        width: '0%',
        exportable: false,
        orderable: false,
        searchable: false,
        visible: {!! auth()->user()->can('edit_coupons') || auth()->user()->can('delete_coupons') ? 'true' : 'false' !!}
    },
    {
        data: 'updated_at',
        name: 'updated_at',
