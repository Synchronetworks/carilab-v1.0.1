...
<div class="card">
  <div class="card-body">
  {{ html()->form('POST' ,route('backend.payouts.update', $data->id))->attribute('enctype', 'multipart/form-data')->attribute('data-toggle', 'validator')->open() }}
        @csrf
        @method('PUT')
        <div class="row">
        ...
        <a href="{{ route('backend.payouts.index') }}" class="btn btn-secondary">{{__('messages.close')}}</a>
