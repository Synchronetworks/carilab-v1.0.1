    ...
    {{ html()->form('POST' ,route('backend.city.store'))->attribute('enctype', 'multipart/form-data')->attribute('data-toggle', 'validator')->open() }}
      ...
      <div class="row">
        <div class="col-sm-6 mb-3">
            {{ html()->label(__('messages.state').' <span class="text-danger">*</span>', 'state_id')->class('form-label') }}
      ...
      <a href="{{ route('backend.city.index') }}" class="btn btn-secondary">{{__('messages.close')}}</a>
