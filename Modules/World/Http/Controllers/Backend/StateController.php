...
class StateController extends Controller
{
    ...
    public function store(StateRequest $request)
    {
        ...
        $this->logActivity('create',$state,'state_create');
        return redirect()->route('backend.state.index', $state->id)->with('success',  __('messages.record_add'));
    ...
    public function update(StateRequest $request, state $state)
    {
        ...
        $this->logActivity('update',$state,'state_update');
        return redirect()->route('backend.state.index', $state->id)->with('success',  __('messages.record_update'));
    }
    ...
    public function destroy($id)
    {
        $data = state::find($id);
        $data->delete();
        $this->logActivity('delete',$data,'state_delete');
    ...
    public function restore($id)
    {
        ...
        $data->restore();
        $this->logActivity('restore',$data,'state_restore');
        return response()->json(['message' => __('messages.state_restore')]);
    }
    ...
    public function forceDelete($id)
    {
        $data = state::withTrashed()->findOrFail($id);
        $data->forceDelete();
        $this->logActivity('force_delete',$data,'state_force_delete');
        return response()->json(['message' => __('messages.state_force_delete')]);
    }
}
