    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if($role->name !== 'admin' && $role->name !== 'user' && $role->name !== 'collector')
                {{ html()->form('post', route('backend.permission-role.store', $role->id))->open() }}


                <div class="permission-collapse border rounded px-3 py-2 mb-3" id="permission_{{$role->id}}">
                    <div class="d-flex align-items-center justify-content-between">
                        <h6 class="m-0">{{ ucfirst($role->title) }}</h6>
        ...
        <div data-render="app">
            <manage-role-form create-title="{{ __('messages.create') }}  {{ __('messages.lbl_role') }}">
            </manage-role-form>
