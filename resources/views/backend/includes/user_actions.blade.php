<div class="text-end">
    ...
    <a href="{{route('backend.users.emailConfirmationResend', $data->id)}}" class="btn btn-primary btn-icon btn-sm" data-bs-toggle="tooltip" data-bs-title="@lang('send_confirmation_email')"><i class="ph ph-envelope-simple"></i></a>
    @endif
</div>
