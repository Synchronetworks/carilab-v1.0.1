...
<div class="sidebar-base pr-hide
    ...
    <div class="d-flex align-items-center justify-content-start">
        <div class="logo-main">
            ...
            <img class="logo-normal img-fluid" src="{{GetSettingValue('logo') ?? asset(setting('logo'))}}" height="30" alt="{{ app_name() }}">
                ...
                <img class="logo-mini dark-mini img-fluid" src="{{asset(setting('light_logo'))}}" height="30" alt="{{ app_name() }}">
            </a>
        </div>
