            ...
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center justify-content-between">
                        <h6>{{__('messages.color_customizer')}}
                        </h6>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    ...
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        ...
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-block" for="page-layout-full-width">{{__('messages.full_width')}}</label>
                        </div>
                    </div>
                </div>
                <hr class="hr-horizontal">
                <div>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-3 g-3 mb-4">
                        <div data-setting="checkbox" class="col">
                        ...
                        <div data-setting="checkbox" class="col">
                            ...
                            <label class="btn btn-border d-block"
                                for="theme-style-appearance-bordered">{{__('messages.borederd')}}</label>
                        </div>
                        <div data-setting="checkbox" class="col">
