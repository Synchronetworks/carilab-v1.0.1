        ...
        <div class="row">
            <div class="col-8">
                <h4 class="card-title mb-0">
                    <i class="{{$module_icon}}"></i> {{ __('messages.logs_by_date') }}
        ...
        <form id="delete-log-form" action="{{ route('log-viewer::logs.delete') }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-secondary mr-auto" data-bs-dismiss="modal">{{__('messages.close')}}</button>
...
<script>
    $(function() {
        var deleteLogModal = $('div#delete-log-modal'),
            ...
            var deleteLogConfirm = `{!! __('messages.delete_log_confirm') !!}`;
            ...
            $("a[href='#delete-log-modal']").on('click', function(event) {
                ...
                // Replace :date in the translation
                var message = deleteLogConfirm.replace(':date', date);

                deleteLogModal.find('.modal-body p').html(message);
