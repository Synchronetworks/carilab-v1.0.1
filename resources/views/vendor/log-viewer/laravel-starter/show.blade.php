                                ...
                                <table class="table table-condensed mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{__('messages.lbl_update_at')}} :</td>
                                            <td>
                                ...
                                <table id="entries" class="table mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 120px;">{{__('messages.lbl_level')}}</th>
        ...
        <form id="delete-log-form" action="{{ route('log-viewer::logs.delete') }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>{{__('messages.are_you_sure_want')}} <span class="badge bg-danger">{{__('messages.delete')}}</span> {{__('messages.this_log_file')}} <span class="badge text-bg-warning">{{ $log->date }}</span> ?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-secondary mr-auto" data-bs-dismiss="modal">{{__('messages.cancel')}}</button>
