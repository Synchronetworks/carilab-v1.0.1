...
return [
    ...
    'PAYMENT_HISTORY_ACTION' =>[
        'CUSTOMER_SEND_COLLECTOR' => 'customer_send_collector',
        'COLLECTOR_COLLECTION' => 'collection_pending_by_collector',
        'COLLECTOR_APPROVED_CASH' => 'collector_approved_cash',
        'COLLECTOR_SEND_VENDOR' => 'collector_send_vendor',
        'VENDOR_APPROVED_CASH' => 'vendor_approved_cash',
        'VENDOR_SEND_ADMIN' => 'vendor_send_admin',
        'COLLECTOR_SEND_ADMIN' => 'collector_send_admin',   
        'ADMIN_APPROVED_CASH' => 'admin_approved_cash',
    ],
    'PAYMENT_HISTORY_STATUS' =>[
        'PENDING_COLLECTOR' => 'pending_by_collector',
        'APPROVED_COLLECTOR' => 'approved_by_collector',
        'SEND_VENDOR' => 'send_to_vendor',
        'PENDING_VENDOR' => 'pending_by_vendor',
        'APPROVED_VENDOR' => 'approved_by_vendor',
    ...
    'MODULES' => [
        ...
        [
            'module_name' => 'vendordocuments',
            'is_custom_permission' => 0,
        ],
        [
            'module_name' => 'collectordocuments',
            'is_custom_permission' => 0,
        ],
        [
            'module_name' => 'catelog',
        ...
        [
            'module_name' => 'vendor_bank',
            'is_custom_permission' => 0,
        ],
        [
            'module_name' => 'collector_bank',
            'is_custom_permission' => 0,
        ],
        [
            'module_name' => 'vendor_payouts',
            'is_custom_permission' => 0,
        ],
        [
            'module_name' => 'collector_payouts',
            'is_custom_permission' => 0,
        ],
        [
            'module_name' => 'vendor_earnings',
            'is_custom_permission' => 0,
        ],
        [
            'module_name' => 'collector_earnings',
            'is_custom_permission' => 0,
        ],
       
        [
            'module_name' => 'collector_history',
            'is_custom_permission' => 0,
        ],
        [
            'module_name' => 'vendor_history',
            'is_custom_permission' => 0,
        ],
        [
        ...
        [
            'module_name' => 'vendor_commisions',
            'is_custom_permission' => 0,
        ],  
        [
            'module_name' => 'collector_commisions',
            'is_custom_permission' => 0,
        ],  
        [
    ...
    'IMAGE_EXTENTIONS' => ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'webp'],
];
