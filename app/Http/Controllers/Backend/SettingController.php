...
class SettingController extends Controller
{
    ...
    public function verify_email(Request $request)
    {
        ...
        try {
            ...
            return response()->json(['message' => __('messages.verification_successfull'), 'status' => true], 200);
        } catch (\Exception $e) {
            return response()->json(['message' => __('messages.verification_failed'), 'status' => false], 500);
        }
    }
