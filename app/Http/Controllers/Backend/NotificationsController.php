...
class NotificationsController extends Controller
{
    ...
    public function bulk_action(Request $request)
    {
        ...
        $moduleName = 'Notification'; // Adjust as necessary for dynamic use
        $messageKey = __('messages.bulk_action'); // You might want to adjust this based on the action

        return $this->performBulkAction(Notification::class, $ids, $actionType, $messageKey, $moduleName);
    }
      ...
      // Fetch the user's notifications
        ...
        ->addColumn('check', function ($data) {
            return '<input type="checkbox" class="form-check-input select-table-row"  
                id="datatable-row-' . $data->id . '"  
                name="datatable_ids[]" 
                value="' . $data->id . '" 
                data-type="notification" 
                onclick="dataTableRowCheck(\'' . $data->id . '\', this)">'; 
        })
    ...
    public function show($id)
    {
        ...
        $$module_name_singular = Notification::where('id', '=', $id)->where('notifiable_id', '=', auth()->id())->first();
    ...
    public function deleteAll()
    {
        ...
        Flash::success("<i class='fas fa-check'></i>".__('messages.all_notification_delete'))->important();
    ...
    public function markAllAsRead()
    {
        ...
        Flash::success("<i class='fas fa-check'></i>" . __('messages.make_as_read'))->important();
